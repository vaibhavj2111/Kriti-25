...
function EcosystemWalletConnectUI(props) {
    ...
    if (state?.walletLogin) {
        return ((0, jsx_runtime_1.jsx)(WalletAuth_js_1.WalletAuth, { meta: props.meta, inAppLocale: locale, walletConnect: props.walletConnect, wallet: props.wallet, client: props.client, size: props.size, done: done, onBack: goBackToMain || (() => setSelectionData({})), locale: props.connectLocale, isLinking: state.walletLogin.linking }));
    }
    if (state?.guestLogin) {
